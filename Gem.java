...

{
	...
	{
		String imageToDraw = "/Users/harshith/eclipse-workspace/GemMatching/data/gem_blue.png";
		if(type == GemType.ORANGE)
		{
			imageToDraw = "/Users/harshith/eclipse-workspace/GemMatching/data/gem_orange.png";
		}
		else if(type == GemType.GREEN)
		{
			imageToDraw = "/Users/harshith/eclipse-workspace/GemMatching/data/gem_green.png";
		}
